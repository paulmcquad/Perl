...
# default. For example, to get a 40x50 maze, type this:
#  
#    perl example_7_4_maze.pl 40 50
# 
...
This version of example_7_4_maze.pl is significantly different (and more
interesting) from that in the book. I recommend reading through the code
to understand some of its interesing features.

If the flicker is annoying, you can try playing around with the Term::Screen
program from the CPAN. It does not work on Windows, but you can try
Term::Screen::Uni and Term::Screen::Win32.
END
